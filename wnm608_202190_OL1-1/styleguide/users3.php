...
<form>
	<div>
		...
		<input type="text" value="Sean Kris" placeholder="Name" class="form-input">
	</div>
	<div>
	...
	<div>
		...
		<input type="text" value="sean@gmail.com" placeholder="Email" class="form-input">
	</div>
	<div>
		<label for="" class="form-label">Classes</label>
		<input type="text" value="742-983-7832" placeholder="Classes" class="form-input">
	</div>
...
<div>
	...
	<div>
		<strong>Email</strong>
		<span>sean@gmail.com</span>
	</div>
	<div>
		<strong>Classes</strong>
		<span>742-983-7832</span>
	</div>
</div>
-->		</div>
	</div>
