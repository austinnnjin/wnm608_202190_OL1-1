...
<header class="navbar">
		...
		<div class="flex-none">&dollar;280.00</div>
	</div>
	<div class="card-section display-flex">
		<div class="flex-stretch">Taxes</div>
		<div class="flex-none">&dollar;20.00</div>
	</div>
	<div class="card-section display-flex">
		<div class="flex-stretch"><strong>Total</strong></div>
		<div class="flex-none"><strong>&dollar;300.00</strong></div>
	</div>
   		...
   		<h2>CHECKOUT</h2>
			<form class="form">
				...
				<div class="form-control">
					<br>
					<br>
					<a href="confirmation.php" class="form-button">CHECKOUT</a>
				</div>
