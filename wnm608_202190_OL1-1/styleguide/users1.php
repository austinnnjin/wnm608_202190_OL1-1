...
<form>
	<div>
		...
		<input type="text" value="Frost Vita" placeholder="Name" class="form-input">
	</div>
	<div>
	...
	<div>
		...
		<input type="text" value="frost@gmail.com" placeholder="Email" class="form-input">
	</div>
	<div>
		<label for="" class="form-label">Classes</label>
		<input type="text" value="342-345-1251" placeholder="Classes" class="form-input">
	</div>
...
<div>
	...
	<div>
		<strong>Email</strong>
		<span>frost@gmail.com</span>
	</div>
	<div>
		<strong>Classes</strong>
		<span>342-345-1251</span>
	</div>
</div>
-->		</div>
	</div>
