...
<div class='grid gap'>
		<div class='col-xs-12 col-md-7'><div class='card soft'>	<div>
		<h2>PITC HOODIE</h2>
		<div class="form-control">
			<label class="form-label">PRICE</label>
			<span>&dollar;120.00</span>
		</div>
		<div class="form-control">
		...
		<div class="form-control">
			...
			<span> Everyone needs a good hoodie. Soft, naturally breathable fabric makes this one just that much better.</span>
		</div>
		<div class="form-control">
			<label class="form-label">THUMBNAIL</label>
			<span class="images-thumbs"><img src='../img/hoodie2.png'></span>
		</div>
		<div class="form-control">
		...
		<div class='col-xs-12 col-md-5'><div class='card soft'><form method="post" action="productadmin.php">
	<h2>Edit Product</h2>
	<div class="form-control">
	...
	<div class="form-control">
		<label class="form-label" for="product-price">PPRICE</label>
