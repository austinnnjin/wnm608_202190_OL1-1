...
<form>
	<div>
		...
		<input type="text" value="David Chris" placeholder="Name" class="form-input">
	</div>
	<div>
	...
	<div>
		...
		<input type="text" value="david@gmail.com" placeholder="Email" class="form-input">
	</div>
	<div>
		<label for="" class="form-label">Classes</label>
		<input type="text" value="330-344-1234" placeholder="Classes" class="form-input">
	</div>
